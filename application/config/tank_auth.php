...
|--------------------------------------------------------------------------
*/
$config['website_name']    = 'Cut Out Image';
$config['website_sologan'] = '';
$config['webmaster_email'] = 'jobaer.shuman@gmail.com';
$config['sender_email']    = 'hello@cutoutimage.com';
$config['admin_email']     = 'hello@cutoutimage.com';
$config['sender_name']     = 'Cut Out Image';
$config['support_email']   = 'hello@cutoutimage.com';
$config['email_support']   = 'hello@cutoutimage.com';
$config['email_sales']     = 'hello@cutoutimage.com';
$config['email_order']     = 'hello@cutoutimage.com';
$config['email_payment']   = 'hello@cutoutimage.com';
$config['email_billing']   = 'hello@cutoutimage.com';
$config['email_technical'] = 'hello@cutoutimage.com';
...
|--------------------------------------------------------------------------
*/
$config['use_recaptcha_login'] = FALSE;
...
|--------------------------------------------------------------------------
*/
$config['forgot_password_expire'] = 24*60*60; // 24hrs (hr x min x sec
