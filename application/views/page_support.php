		...
		<section class="vbox">
			<section class="scrollable padder">              
				<section class="row m-b-md">
					<div class="col-sm-6">
						<h3 class="m-b-xs text-black">Support</h3>
						...
						<form name="contact_form" id="contact_form" action="" method="post" data-validate="parsley">
							...
							<section class="panel panel-default">
								<header class="panel-heading">
									<span class="h4">Support Form</span>
								</header>
								<div class="panel-body">
									...
									<div class="form-group pull-in clearfix">
										<div class="col-sm-6">
											...
											<select name="department" class="form-control m-b">
												...
												<option value="payment">Quotation</option>
									...
									<div class="form-group pull-in clearfix">
										<div class="col-sm-6">
											...
											<input type="text" class="form-control" name="fullname" data-required="true" value="<?php echo $this->user_profile->fullname;?>" readonly>
										</div>
										<div class="col-sm-6">
											<label>Email</label>
											<input type="email" class="form-control" name="email" data-required="true"  value="<?php echo $this->user_profile->email;?>" readonly>
										</div>
									</div>
								...
								<footer class="panel-footer text-right bg-light lter">
									<button type="submit" class="btn btn-info btn-s-xs">SEND MESSAGE</button>
								</footer>
							</section>
						</form>
					</div>
						...
						<form data-validate="parsley">
							<section class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div id="gmap_canvas" style="height:310px;width:100%;"></div>
									...
									<script type="text/javascript"> function init_map(){var myOptions = {zoom:15,center:new google.maps.LatLng(23.88311, 90.38921),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(23.881941,90.390716)});infowindow = new google.maps.InfoWindow({content:"<b><strong>Cut Out Image (COI)</strong></b><br />Plot # 05, Suite # A5, Road # 06<br>Sector # 10, Uttara Model Town<br/>Dhaka-1230, Bangladesh" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>

								</div>
								<footer class="panel-footer text-right bg-light lter">
									<h4 class="text-info">Cut Out Image</h4>
