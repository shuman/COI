                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="clearfix order_view">
                                                <form id="orderForm" action="" method="post" name="orderForm">
                                                    ...
                                                    <div class="lead-13 text-left font-weight-600 m-b-n m-t-lg"><span class="text-dark">Flatness &amp; Metadata Info</span></div>
                                                    <hr>
                                                    <div class="form-horizontal"></div>
                                                    <div class="inline form-group m-t-n m-b-xs col-sm-12 no-padder">
                                                        <div class="no-padder col-sm-8 cocp">
                                                            ...
                                                            <label class="checkbox i-checks">
                                                                <input type="checkbox" name="keep_metadata" ng-model="keep_meta" ng-checked="keep_meta" value="0" disabled><i></i>Keep My Metadata Intact <strong> - </strong><a data-toggle="ajaxModal" href ="<?php echo site_url('ajax/metadata_info'); ?>" class="text-danger font-normal">What's This?</a>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <hr class="m-t-xs m-b-lg">
                                                    <div class="form-horizontal"></div>
                                                    <div class="inline form-group m-t-n m-l-n">
                                                    ...
                                                    <div class="inline lead-13 text-left font-weight-600 m-b-n m-t-n text-dark">Background Options:</div>
                                                    <hr class="m-t-xs m-b-lg">
                                                    <div class="form-horizontal"></div>
                                                    <div class="inline form-group m-t-n m-l-n">
                                                        <div class="col-sm-12 rf_format" style="min-height: 25px;">
                                                    ...
                                                    <div class="clearfix noheight"></div>
                                                    <div class="inline lead-13 text-left font-weight-600 m-b-n"><span class="text-dark">Price / Image:</span> Choose Image Complexity</div> 
                                                    <hr class="m-t-xs m-b-lg"> 
                                                        ...
                                                        <div class="form-horizontal"> 
                                                            <div id="img_complexity" class="form-group v2">
                                                                <label class="complexity_item" for="ic_option_1" ng-class="{selected: imgCmplx.defaultType === 'basic'}" ng-click="imgCmplx.defaultType = 'basic'">
                                                                    ...
                                                                    <input type="radio" class="hide" id="ic_option_1" name="image_complexity" data-title="CP Basic" value="{{servicePrice.complexity.basic|currency:'':2}}" 
                                                                ...
                                                                <label class="complexity_item" for="ic_option_2" ng-class="{selected: imgCmplx.defaultType === 'regular'}" ng-click="imgCmplx.defaultType = 'regular'">
                                                                    ...
                                                                    value="{{servicePrice.complexity.regular|currency:'':2}}" 
                                                                    ng-model="imgCmplx.defaultValue" />
                                                                </label>
                                                                <label class="complexity_item" for="ic_option_3" ng-class="{selected: imgCmplx.defaultType === 'medium'}" ng-click="imgCmplx.defaultType = 'medium'">
                                                                    ...
                                                                    value="{{servicePrice.complexity.medium|currency:'':2}}" 
                                                                    ng-model="imgCmplx.defaultValue"/>
                                                                </label>
                                                                <label class="complexity_item" for="ic_option_4" ng-class="{selected: imgCmplx.defaultType === 'advance'}" ng-click="imgCmplx.defaultType = 'advance'">
                                                                    ...
                                                                    value="{{servicePrice.complexity.advance|currency:'':2}}" 
                                                                    ng-model="imgCmplx.defaultValue"/>
                                                                </label>
                                                                <label class="complexity_item" for="ic_option_5" ng-class="{selected: imgCmplx.defaultType === 'complex'}" ng-click="imgCmplx.defaultType = 'complex'">
                                                                    ...
                                                                    value="{{servicePrice.complexity.complex|currency:'':2}}" 
                                                                    ng-model="imgCmplx.defaultValue"/>
                                                                </label>
                                                    ...
                                                    <section class="panel panel-default" ng-controller="shadowAdding">
                                                        ...
                                                        <div class="panel-body" ng-show="shadowOn">
                                                            <div class="col-sm-6 no-padder">
                                                                ...
                                                                <div class="radio i-checks"><label><input ng-click="showImage($event); shadowValue = 0.50" data-img="2.jpg" type="radio" name="shadow_option" value="Natural Shadow: ($0.50)"><i></i>Natural Shadow - <span class="text-info">$0.50</span></label></div>
                                                                <div class="radio i-checks"><label><input ng-click="showImage($event); shadowValue = 0.50" data-img="3.jpg" type="radio" name="shadow_option" value="Reflection Shadow: ($0.50)"><i></i>Reflection Shadow - <span class="text-info">$0.50</span></label></div>
                                                    ...
                                                    <section class="panel panel-default">
                                                        <header class="panel-heading">
                                                            <div style="position:relative;">
                                                                <label class="switch" style="position:absolute; right: 0px; top: -1px;">
                                                                    <input type="checkbox" name="mannequin_option" value="Mannequin: ($0.75)" ng-model="mannequinOn" />
                                                                    <span></span>
                                                                </label> 
                                                        ...
                                                        <div class="panel-body" ng-show="mannequinOn">
                                                            <div class="col-sm-12 no-padder">
                                                                ...
                                                                <label class="radio-inline i-checks"><input type="radio" name="mannequin_option_value" value="0.75" ng-checked="mannequinOn"><i></i>3D Ghost / Invisible Mannequin - <span class="text-info">$0.75</span></label>
                                                                <label class="radio-inline i-checks"><input type="radio" name="mannequin_option_value" ng-click="mannequinOn=false" value="none" ng-checked="!mannequinOn"><i></i>None</label>
                                                                <hr>
                                                            </div>
                                                            <div class="col-sm-12 no-padder">
                                                                <div class="thumbnail"> 
                                                    ...
                                                    <section class="panel panel-default">
                                                        ...
                                                        <div class="panel-body" ng-show="RetouchOn">
                                                            <div class="col-sm-12 no-padder">
                                                                ...
                                                                <label class="checkbox i-checks">
                                                                    <input type="checkbox" name="retbasic_value" ng-model="retouch_basic" ng-checked="RetouchOn" value="Basic Photo Retouching"><i></i>Basic Photo Retouching - <span class="text-info">$1.00</span>
                                                                </label>
                                                                <label class="checkbox i-checks">
                                                        ...
                                                        <div class="panel-body" ng-show="resizingOn">
                                                            <div class="col-sm-12 text-left no-padder">
                                                                ...
                                                                <label class="radio i-checks">
                                                                    <input type="radio" name="crop_resize" value="Variation (Upto 3)" ng-checked="resizingOn"><i></i>Variation (Upto 3): <span class="text-info">$0.25</span>
                                                                </label>
                                                                <label class="radio i-checks">
                                                                    <input type="radio" name="crop_resize" value="Variation (Upto 1)" ng-disabled="!resizingOn"><i></i>Variation (Upto 1): <span class="text-info">Free</span>
                                                                </label>
                                                                <label class="radio i-checks">
                                                    ...
                                                    <section class="panel panel-default">
                                                        ...
                                                        <div class="panel-body" ng-show="colorOn">
                                                            ...
                                                            <div class="m-b-n wrapper">
                                                                <textarea name="color_fix_desc" class="form-control input-sm block" rows="3" data-minwords="6" placeholder="Please write down your instructions here" ng-required='colorOn' ></textarea>
                                                            </div>
                                                        </div>
                                                    </section>
                                                </form> 
                                            ...
                                            <div class="clearfix quote_view hide">
                                                ...
                                                <form id="quoteForm" action="" method="post" name="quoteForm" novalidate>
                                                    ...
                                                    <hr>
                                                    <div class="m-t-n m-b-sm clearfix" id="quote_services">
                                                    ...
                                                    <div class="form-group m-t-n m-l-n">
                                                        <div class="col-sm-12 m-b-lg rf_format">
                                                            ...
                                                            <label class="" ng-show="bgOpt == 'Custom'">
                                                                <div class="custom-color-qwidget">
                                                ...
                                                <div class="form-group m-b-none">
                                                    <div class="col-sm-12 m-b-none">
                                                        ...
                                                        <div class="m-t-n">
                                                            ...
                                                            <label class="radio i-checks">
                                                                <input ng-model="paymentOption.text" ng-click="hide_payment = true" name="payment_option" value="Place Order" type="radio"><i></i>Pay Later <a data-toggle="ajaxModal" href ="<?php echo site_url('ajax/pay_later'); ?>">(<span class="text-info dker" data-toggle="tooltip" data-placement="top" data-title="Option For Regular Customers">Monthly</span>)</a>
                                                            </label>
                                                        ...
                                                        <div id="payment_method" ng-hide="hide_payment">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-7 m-l-n p-r-none hide">
                                                                    <label class="radio i-checks">
                                                        ...
                                                        <div class="m-t submit_btn_wrap">
                                                            ...
                                                            <i ng-show="orderForm.$invalid" class="fa fa-exclamation-circle text-danger" data-toggle="tooltip" data-placement="left" title="Job Title Required!"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-b-none">
                                                <div class="col-sm-12 m-b-none">
                                                    ...
                                                    <div class="m-t submit_btn_wrap">
                                                        ...
                                                        <i ng-show="quoteForm.$invalid" class="fa fa-exclamation-circle text-danger" data-toggle="tooltip" data-placement="left" title="Title & Description Required!"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="application/javascript">
    $('document').ready(function(){
        var d = new Date();
        var n = d.getTime();
        var folder = 'XX ALL TEMPORARY FILES/F-UID-'+<?php echo $this->user_id;?>+'-TI-'+n+'/${filename}';
        $('#keyInput').val(folder);
    });
        ...
        Dropzone.options.fileUpload = {
            init: function() {
                ...
                this.on("removedfile", function(file){
                    var folderTempName = $('#keyInput').val();
                    var folderName = folderTempName.split('/');
                    var url = ajax_url + "/delete_aws/" + folderName[0] + "/" + file.name;
                    $.ajax({
                        url: url,
                        data: file.name,
                        type: 'POST',
            ...
            thumbnailWidth: 80,
            thumbnailHeight: 50,
            maxThumbnailFilesize: 0.5, //MB
            parallelUploads: 8,
            dictCancelUpload: "Cancel Upload",
            dictRemoveFile: "Remove File",
            acceptedFiles: "image/*,.psd,.ai,.eps,.tif,.tiff,.pdf,.crw,.cr2,.dng,.nef,.raw,.rw2,.PSD,.AI,.EPS,.TIF,.TIFF,.PDF,.CRW,.CR2,.DNG,.NEF,.RAW,.RW2",
    ...
    $(".header.navbar a").click(function(e) {
        ...
        if (check_valu == 1 && r_url) {
            Portal.alert({title: "Leave Page?", text: msg, type: "dark", confirm: true, href: href});
            e.preventDefault();
        }else {
            return true;
        }
